        ...
        class Formatting : ProjectGenerationTestBase
        {
            ...
            public void DefaultSyncSettings_WhenSynced_CreatesProjectFileFromDefaultTemplate()
            {
                ...
                var content = new[]
                {
                    ...
                    $"    <TargetFramework>Unity,{m_Builder.Assembly.compilerOptions.ApiCompatibilityLevel}</TargetFramework>",
                    $"    <NuGetTargetMoniker>Unity,{m_Builder.Assembly.compilerOptions.ApiCompatibilityLevel}</NuGetTargetMoniker>",
